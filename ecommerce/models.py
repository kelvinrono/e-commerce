...
class Order(models.Model):
    customer=models.ForeignKey(Customer, related_name='customer', on_delete=models.SET_NULL, null=True, blank=True)
...
class ShippingAddress(models.Model):
    ...
    zipcode=models.CharField(max_length=255, null=255)
    date_added=models.DateTimeField(auto_now_add=True)
